...
<?php
	...
	?><ul>
		...
		?><ul>
		<li><?php echo $this->Html->link(__('Token View'), array('action' => 'saleView', $auth['Auth']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Token Sale View'), array('action' => 'saleView', $auth['Auth']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Void View'), array('action' => 'voidView', $auth['Auth']['id'])); ?> </li>
	</ul><?php
	}
?>
